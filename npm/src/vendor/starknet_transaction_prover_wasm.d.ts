...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_55381: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_55366: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_117565: (a: number, b: number, c: number, d: number) => void;
